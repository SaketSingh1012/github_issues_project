...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../.nvm/versions/node/v18.18.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"node_modules/universal-user-agent/dist-web/index.js":[function(require,module,exports) {
...
},{"process":"../../../.nvm/versions/node/v18.18.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/before-after-hook/lib/register.js":[function(require,module,exports) {
...
},{}],"node_modules/before-after-hook/lib/add.js":[function(require,module,exports) {
...
},{}],"node_modules/before-after-hook/lib/remove.js":[function(require,module,exports) {
...
},{}],"node_modules/before-after-hook/index.js":[function(require,module,exports) {
...
},{"./lib/register":"node_modules/before-after-hook/lib/register.js","./lib/add":"node_modules/before-after-hook/lib/add.js","./lib/remove":"node_modules/before-after-hook/lib/remove.js"}],"node_modules/is-plain-object/dist/is-plain-object.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@octokit/endpoint/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // pkg/dist-src/defaults.js
// pkg/dist-src/version.js
var VERSION = "9.0.2";

// pkg/dist-src/defaults.js
var userAgent = "octokit-endpoint.js/".concat(VERSION, " ").concat((0, _universalUserAgent.getUserAgent)());
var DEFAULTS = {
  method: "GET",
...
function withDefaults(oldDefaults, newDefaults) {
  var DEFAULTS2 = merge(oldDefaults, newDefaults);
  var endpoint2 = endpointWithDefaults.bind(null, DEFAULTS2);
...
},{"universal-user-agent":"node_modules/universal-user-agent/dist-web/index.js","is-plain-object":"node_modules/is-plain-object/dist/is-plain-object.mjs"}],"node_modules/deprecation/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/wrappy/wrappy.js":[function(require,module,exports) {
...
},{"wrappy":"node_modules/wrappy/wrappy.js"}],"node_modules/@octokit/request-error/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } // pkg/dist-src/index.js
var logOnceCode = (0, _once.default)(function (deprecation) {
  return console.warn(deprecation);
});
var logOnceHeaders = (0, _once.default)(function (deprecation) {
  return console.warn(deprecation);
});
var RequestError = exports.RequestError = /*#__PURE__*/function (_Error) {
...
},{"deprecation":"node_modules/deprecation/dist-web/index.js","once":"node_modules/once/once.js"}],"node_modules/@octokit/request/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // pkg/dist-src/index.js
// pkg/dist-src/version.js
var VERSION = "8.1.5";
...
function fetchWrapper(requestOptions) {
  ...
  return fetch(requestOptions.url, _objectSpread({
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            _context.t0 = _requestError.RequestError;
            _context.t1 = status;
            _context.t2 = url;
            _context.t3 = status;
            _context.t4 = headers;
          ...
          case 27:
            data = _context.sent;
            error = new _requestError.RequestError(toErrorMessage(data), status, {
              response: {
                url: url,
                status: status,
                headers: headers,
    ...
    if (error instanceof _requestError.RequestError) throw error;else if (error.name === "AbortError") throw error;
...
function withDefaults(oldEndpoint, newDefaults) {
  var endpoint2 = oldEndpoint.defaults(newDefaults);
  var newApi = function newApi(route, parameters) {
    var endpointOptions = endpoint2.merge(route, parameters);
    if (!endpointOptions.request || !endpointOptions.request.hook) {
      return fetchWrapper(endpoint2.parse(endpointOptions));
    }
    var request2 = function request2(route2, parameters2) {
...
var request = exports.request = withDefaults(_endpoint.endpoint, {
  headers: {
    "user-agent": "octokit-request.js/".concat(VERSION, " ").concat((0, _universalUserAgent.getUserAgent)())
  }
});
},{"@octokit/endpoint":"node_modules/@octokit/endpoint/dist-web/index.js","universal-user-agent":"node_modules/universal-user-agent/dist-web/index.js","is-plain-object":"node_modules/is-plain-object/dist/is-plain-object.mjs","@octokit/request-error":"node_modules/@octokit/request-error/dist-web/index.js"}],"node_modules/@octokit/graphql/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
var GraphqlResponseError = exports.GraphqlResponseError = /*#__PURE__*/function (_Error) {
  _inherits(GraphqlResponseError, _Error);
  var _super = _createSuper(GraphqlResponseError);
...
// pkg/dist-src/index.js
var graphql2 = exports.graphql = withDefaults(_request.request, {
  headers: {
    "user-agent": "octokit-graphql.js/".concat(VERSION, " ").concat((0, _universalUserAgent.getUserAgent)())
  },
  method: "POST",
  url: "/graphql"
});
...
},{"@octokit/request":"node_modules/@octokit/request/dist-web/index.js","universal-user-agent":"node_modules/universal-user-agent/dist-web/index.js"}],"node_modules/@octokit/auth-token/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
var createTokenAuth = exports.createTokenAuth = function createTokenAuth2(token) {
  if (!token) {
...
},{}],"node_modules/@octokit/core/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
// pkg/dist-src/index.js
var Octokit = exports.Octokit = (_class = /*#__PURE__*/function () {
  function Octokit() {
    var _this = this;
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, Octokit);
    var hook = new _beforeAfterHook.Collection();
    var requestDefaults = {
    ...
    requestDefaults.headers["user-agent"] = [options.userAgent, "octokit-core.js/".concat(VERSION, " ").concat((0, _universalUserAgent.getUserAgent)())].filter(Boolean).join(" ");
    if (options.baseUrl) {
    ...
    if (!options.authStrategy) {
      if (!options.auth) {
        ...
        var auth = (0, _authToken.createTokenAuth)(options.auth);
  ...
  _createClass(Octokit, null, [{
    ...
    function plugin() {
      ...
      var NewOctokit = (_class2 = /*#__PURE__*/function (_this4) {
        _inherits(NewOctokit, _this4);
        var _super2 = _createSuper(NewOctokit);
        function NewOctokit() {
...
},{"universal-user-agent":"node_modules/universal-user-agent/dist-web/index.js","before-after-hook":"node_modules/before-after-hook/index.js","@octokit/request":"node_modules/@octokit/request/dist-web/index.js","@octokit/graphql":"node_modules/@octokit/graphql/dist-web/index.js","@octokit/auth-token":"node_modules/@octokit/auth-token/dist-web/index.js"}],"node_modules/@octokit/plugin-request-log/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@octokit/plugin-paginate-rest/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/@octokit/plugin-rest-endpoint-methods/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
function endpointsToMethods(octokit) {
  var newMethods = {};
  var _iterator = _createForOfIteratorHelper(endpointMethodsMap.keys()),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
...
},{}],"node_modules/@octokit/rest/dist-web/index.js":[function(require,module,exports) {
"use strict";
...
var _pluginRequestLog = require("@octokit/plugin-request-log");
...
// pkg/dist-src/index.js
var Octokit = exports.Octokit = _core.Octokit.plugin(_pluginRequestLog.requestLog, _pluginRestEndpointMethods.legacyRestEndpointMethods, _pluginPaginateRest.paginateRest).defaults({
  userAgent: "octokit-rest.js/".concat(VERSION)
});
},{"@octokit/core":"node_modules/@octokit/core/dist-web/index.js","@octokit/plugin-request-log":"node_modules/@octokit/plugin-request-log/dist-web/index.js","@octokit/plugin-paginate-rest":"node_modules/@octokit/plugin-paginate-rest/dist-web/index.js","@octokit/plugin-rest-endpoint-methods":"node_modules/@octokit/plugin-rest-endpoint-methods/dist-web/index.js"}],"token.js":[function(require,module,exports) {
"use strict";
...
var githubToken = exports.githubToken = "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";
...
var octokit = new _rest.Octokit({
  auth: _token.githubToken
});
function showIssues() {
  return _showIssues.apply(this, arguments);
}
function _showIssues() {
  _showIssues = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var response, issuesList, updateButtons, closeButtons;
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          response.data.forEach(function (issue) {
            ...
            issueElement.innerHTML = "\n        <strong>".concat(issue.title, "</strong>\n        <p>").concat(issue.body, "</p>\n        <p>State: ").concat(issue.state, "</p>\n        <button class=\"update-button\" data-issue-number=\"").concat(issue.number, "\">Update</button>\n        <button class=\"close-button\" data-issue-number=\"").concat(issue.number, "\">Close</button>\n        <hr>\n      ");
          ...
          updateButtons.forEach(function (button) {
            button.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    issueNumber = button.dataset.issueNumber;
                    _context.next = 3;
        ...
        case 13:
          ...
          console.error("Error fetching issues:", _context3.t0);
        case 16:
        case "end":
...
function _createIssue() {
  _createIssue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var title, body;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          console.error("Error creating issue:", _context4.t0);
        case 11:
        case "end":
...
function updateIssue(_x) {
  return _updateIssue.apply(this, arguments);
}
function _updateIssue() {
  _updateIssue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(issueNumber) {
    var updateButton, issue, newTitle, newBody, _updateButton;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          newTitle = prompt("Enter new title:", issue.data.title);
          newBody = prompt("Enter new body:", issue.data.body);
          _context5.next = 11;
        ...
        case 13:
          ...
          console.error("Error updating issue:", _context5.t0);
        case 16:
          _context5.prev = 16;
          _updateButton = document.querySelector(".update-button[data-issue-number=\"".concat(issueNumber, "\"]"));
...
function _closeIssue() {
  _closeIssue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(issueNumber) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          console.error("Error closing issue:", _context6.t0);
        case 11:
          _context6.prev = 11;
          _closeButton = document.querySelector(".close-button[data-issue-number=\"".concat(issueNumber, "\"]"));
...
showIssues();
document.getElementById("create-issue-button").addEventListener("click", createIssue);
},{"@octokit/rest":"node_modules/@octokit/rest/dist-web/index.js","./token":"token.js"}],"../../../.nvm/versions/node/v18.18.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nvm/versions/node/v18.18.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
